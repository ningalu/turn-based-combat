...
struct BattleTypes {
  ...
  using TBattle          = Battle<TUnit, TBattleState, TCommands, TCommandResult>;
  using TBattleScheduler = BattleScheduler<TUnit, TBattleState, TCommands, TCommandResult, TEvents>;

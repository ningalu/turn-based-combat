...
hidden if the `ngl-tbc-2_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ngl-tbc-2_DEVELOPER_MODE` to the configure
...
Runs the executable target `ngl-tbc-2_exe`.

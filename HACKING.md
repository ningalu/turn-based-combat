...
hidden if the `ningalu-turn-based-combat-2_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `ningalu-turn-based-combat-2_DEVELOPER_MODE` to the configure
...
Runs the executable target `ningalu-turn-based-combat-2_exe`.
